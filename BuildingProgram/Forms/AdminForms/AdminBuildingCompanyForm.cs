...
{
    public partial class AdminBuildingCompanyForm : OldBaseForm
    {
        private readonly AppDbContext _context;
        private int _companyId;
        bool siderbarExpand = false;
        bool reportCollapse = true;
        public AdminBuildingCompanyForm()
        {
            InitializeComponent();
        ...
        private void AdminBuildingCompanyForm_Load(object sender, EventArgs e)
        {
